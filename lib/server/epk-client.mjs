export async function createEpkPaymentLink({ transactionId, grossAmount, subMerchantId: gallerySubMerchantId }) {
  ...
  const subMerchantId = gallerySubMerchantId || process.env.EPK_SUB_MERCHANT_ID;
